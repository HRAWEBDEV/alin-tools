...
export default function Tabs() {
 ...
 return (
  <nav className='flex items-center lg:hidden fixed end-0 start-0 bottom-0 z-(--app-restaurant-tabs-zindex) bg-neutral-100 *:shrink-0 border-t border-input text-neutral-700'>

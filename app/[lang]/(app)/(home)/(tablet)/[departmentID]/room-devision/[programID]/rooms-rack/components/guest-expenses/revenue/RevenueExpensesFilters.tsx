...
export default function RevenueExpensesFilters({
 ...
 const { control, watch, setValue, getValues } =
  useFormContext<GuestExpensesInvoice>();
    ...
    <div>
     <Drawer>
      <DrawerTrigger>
       ...
       >
        <div className='flex gap-1 items-center border-e border-border pe-1 me-1'>
        ...
        <div className='mx-auto w-[min(100%,40rem)] grid grid-cols-1 sm:grid-cols-2 gap-4'>
         <div className='col-span-full flex justify-center items-center gap-4'>
          <Button size='lg' variant='outline' onClick={goToPrevDay}>
           {dic.guestExpensesInvoice.prevDay}
          </Button>
          <Button size='lg' variant='outline' onClick={goToNextDay}>
           {dic.guestExpensesInvoice.nextDay}
          </Button>
         </div>
         <Controller
          control={control}
           ...
           render={({ field }) => (
            <Drawer>
             ...
             <DrawerContent className='h-[min(60svh,35rem)]'>
              ...
              <div>
               <ul>
                {initialData?.minibarPrograms.map((item) => (
       ...
       >
        <p className='text-start grow overflow-hidden text-ellipsis'>
         <span className='text-neutral-500'>
          {dic.guestExpensesInvoice[item.key]}:{' '}
         </span>
         {badgeValue}
        </p>
        <Button
         ...
         onClick={() => {
          setValue(
           ...
           defaultValues[
            item.key
           ] as GuestExpensesInvoice[keyof GuestExpensesInvoice],
          );
         }}
        >
         <FaRegTrashAlt />

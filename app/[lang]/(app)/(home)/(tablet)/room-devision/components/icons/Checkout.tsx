...
export function Checkout(props: SVGProps<SVGSVGElement>) {
 return (
  <svg
   version='1.1'
  ...
  >
   ...
   <g id='Icons'>
    ...
    />
    <polygon points='19.485,22.364 16.949,19.828 16.949,24 14.95,24 14.95,19.828 12.414,22.364 11,20.95 15.95,16 20.899,20.95 	' />

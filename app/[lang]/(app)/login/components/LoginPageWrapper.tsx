 ...
 return (
  <div className='text-foreground dark:text-foreground h-full w-full flex flex-col z-1'>
   <motion.div
    ...
    className='p-4 pb-10 glass-card h-full sm:h-auto bg-white/30 dark:bg-black/30 w-full sm:w-[min(100%,28rem)] m-auto border border-input sm:rounded-lg sm:shadow-lg'
   >
    <LoginControllers />
